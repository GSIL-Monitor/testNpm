    ...
    return function (_React$Component) {
      ...
      function _class2() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_class2)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this.componentDidMount = function () {
          ...
          _this.erd.listenTo((0, _reactDom.findDOMNode)(_this), _this.onResize);

          _this.setSizeToState();
        }, _this.componentWillUnmount = function () {
          if ((0, _isFunction2.default)(_this.onResize.cancel)) {
            _this.onResize.cancel();
          }

          _this.erd.removeListener((0, _reactDom.findDOMNode)(_this), _this.onResize);
        }, _this.setSizeToState = function () {
          return _this.setState({ DOMSize: (0, _pick2.default)((0, _reactDom.findDOMNode)(_this), pickedProps) });
...
exports.default = (0, _createHelper2.default)(withSize, 'withSize');